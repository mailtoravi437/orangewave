  ...
  return (
    <div>
      <section className="bg-White dark:bg-gray-900">
        <div className="grid max-w-screen-xl py-8 px-6 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="lg:col-span-7 lg:flex">
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
              {data.map((item, index) => (
                <div key={index} className="flex flex-col">
                  ...
                  />
                  <h3 className="text-left text-xl font-extrabold font-montserrat text-gray-900 mb-2">
                    {item.heading}
                  </h3>
          ...
          <div className="mr-auto  lg:col-span-5 px-8">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white font-montserrat">
